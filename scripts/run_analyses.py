...
inferencePipeline = likelihoodCalcs.LikelihoodInference_jointSFS(regen=regen,pop1_size=10, pop2_size=10,sim_back=[0,500000])

# read and write pickle data
inferencePipeline.make_data_dict_vcf(fn, "data/popmapSims.txt", pickleWrite = True, outFile = 'data/sim.pkl.bz2')
...
ECB_stats_100kb = inferencePipeline.T2D_scan(ECB_wg_dict, numSnps=500, chrom=1)
